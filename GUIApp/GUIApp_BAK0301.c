...
#define ID_BUTTON_SYSTEM_OK						(GUI_ID_USER + 0x13)
#define ID_BUTTON_SYSTEM_CANCLE				(GUI_ID_USER + 0x14)
#define ID_TEXT_WIN3_1								(GUI_ID_USER + 0x15)
//#define ID_TEXT_WIN3_2								(GUI_ID_USER + 0x16)
//#define ID_TEXT_WIN3_3								(GUI_ID_USER + 0x17)
...
extern RC_SAVE_DATA_TypeDef MODEL_X;
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreateWindow3[] = {
  ...
  { BUTTON_CreateIndirect, 		"CH3", 				ID_BUTTON_CH3, 						50, 	100, 	80, 	80, 		0, 0,	0 },
  { BUTTON_CreateIndirect, 		"CH4", 				ID_BUTTON_CH4, 						170, 	100, 	80, 	80, 		0, 0,	0 },
	//{ TEXT_CreateIndirect, 			"MODEL SEL",	ID_TEXT_WIN3_1 , 					100, 	90, 	100, 	15, 		TEXT_CF_HCENTER|TEXT_CF_VCENTER ,0,0},
	//{ TEXT_CreateIndirect, 			"STR TRIM",		ID_TEXT_WIN3_2 , 					40, 	135, 	110, 	15, 		TEXT_CF_HCENTER|TEXT_CF_VCENTER ,0,0},
	//{ TEXT_CreateIndirect, 			"THT TRIM",		ID_TEXT_WIN3_3 , 					150, 	135, 	110, 	15, 		TEXT_CF_HCENTER|TEXT_CF_VCENTER ,0,0},
  //{ SPINBOX_CreateIndirect, 	"Spinbox1", 	ID_SPINBOX_STR, 					50, 	100, 	90,		30, 		0, 0,	0 },
  //{ SPINBOX_CreateIndirect, 	"Spinbox2", 	ID_SPINBOX_THRT, 					160, 	100, 	90, 	30, 		0, 0,	0 },
};
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreateWinConfig[] = {
  ...
  { MULTIPAGE_CreateIndirect,		"Multipage",	ID_MULTIPAGE_0,			0, 0, 800, 480, 0, 0x0, 0 },
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreatePage1[] = {
  ...
  { TEXT_CreateIndirect,			"Text",					ID_P1_TEXT_0,				50,		20,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P1_TEXT_1,				50,		70,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P1_TEXT_2,				50,		120,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P1_TEXT_3,				50,		170,	80,		35,		0, 0x0, 0 },
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreatePage2[] = {
  ...
  { TEXT_CreateIndirect,			"Text",					ID_P2_TEXT_0,				50,		20,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P2_TEXT_1,				50,		70,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P2_TEXT_2,				50,		120,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P2_TEXT_3,				50,		170,	80,		35,		0, 0x0, 0 },
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreatePage3[] = {
  ...
  { TEXT_CreateIndirect,			"Text",					ID_P3_TEXT_0,				50,		20,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P3_TEXT_1,				50,		70,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P3_TEXT_2,				50,		120,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P3_TEXT_3,				50,		170,	80,		35,		0, 0x0, 0 },
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreatePage4[] = {
  ...
  { TEXT_CreateIndirect,			"Text",					ID_P4_TEXT_0,				50,		20,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P4_TEXT_1,				50,		70,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P4_TEXT_2,				50,		120,	80,		35,		0, 0x0, 0 },
  { TEXT_CreateIndirect,			"Text",					ID_P4_TEXT_3,				50,		170,	80,		35,		0, 0x0, 0 },
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreateWinSystem[] = {
  { FRAMEWIN_CreateIndirect, "Save", ID_WINDOW_SYSTEM, 0, 0, 300, 280, 0, 0x0, 0 },
	{ TEXT_CreateIndirect, "SYSTEM?",ID_WINDOW_SYSTEM , 50, 75, 200, 10, TEXT_CF_HCENTER|TEXT_CF_VCENTER },
  { BUTTON_CreateIndirect, "OK", ID_BUTTON_SYSTEM_OK, 75, 150, 60, 30 },
	{ BUTTON_CreateIndirect, "Cancel", ID_BUTTON_SYSTEM_CANCLE, 300-75-50, 150, 60, 30 },
};
    ...
    case GUI_ID_ICONVIEW_WM1:
      ...
      case WM_NOTIFICATION_SEL_CHANGED:
        ...
        if(Sel==0)				//Home
				...
				else if(Sel==3)		//Syetem
				{
					_RC_hWindowSystem=GUI_CreateDialogBox(_aDialogCreateWinSystem, GUI_COUNTOF(_aDialogCreateWinSystem), _RC_cbFrameWinSystem, WM_HBKWIN, 300, 100);
				}
        break;
      }
    break;
...
static void _RC_cbWindow2(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    ...
    GUI_SetColor(GUI_RED);
		...
		GUI_SetColor(GUI_GREEN);
		GUI_DispFloatMin(_textnum[5].num, 1);
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_CH3: // Notifications sent by 'CH3'
     	switch(NCode) {
			case WM_NOTIFICATION_CLICKED:		
				ButtonCh3Pressed^=1;
        if(ButtonCh3Pressed==1)
					BUTTON_SetText(hButtonCh3,"CH3 ON");
					//user application
				else
					BUTTON_SetText(hButtonCh3,"CH3");
				break;
      }
			break;
    case ID_BUTTON_CH4: // Notifications sent by 'CH4'
      switch(NCode) {
			case WM_NOTIFICATION_CLICKED:
				ButtonCh4Pressed^=1;
				if(ButtonCh4Pressed==1)
					BUTTON_SetText(hButtonCh4,"CH4 ON");
					//user application
				else
					BUTTON_SetText(hButtonCh4,"CH4");
				break;
			}
...
static void _RC_cbFrameWinConfig(WM_MESSAGE* pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    hItem = WM_GetDialogItem(pMsg->hWin, ID_MULTIPAGE_0);
		hWinPage1 = CreateWindowP1(hItem);
		MULTIPAGE_AddEmptyPage(hItem, hWinPage1, "CH1");
		MULTIPAGE_SetFont(hItem, &GUI_Font24B_ASCII);
	
		hWinPage2 = CreateWindowP2(hItem);
		MULTIPAGE_AddEmptyPage(hItem, hWinPage2, "CH2");
		MULTIPAGE_SetFont(hItem, &GUI_Font24B_ASCII);
	
		hWinPage3 = CreateWindowP3(hItem);
		MULTIPAGE_AddEmptyPage(hItem, hWinPage3, "CH3");
		MULTIPAGE_SetFont(hItem, &GUI_Font24B_ASCII);
	
		hWinPage4 = CreateWindowP4(hItem);
		MULTIPAGE_AddEmptyPage(hItem, hWinPage4, "CH4");
		MULTIPAGE_SetFont(hItem, &GUI_Font24B_ASCII);
    ...
    case ID_P1_SCROLLBAR_0: // Notifications sent by 'Scrollbar'
      switch(NCode) {
        ...
        WM_GetScrollState(hScrollBar0,&pState0_p1);
				...
				GUI_SetTextMode(GUI_TM_TRANS);
				GUI_SetColor(GUI_RED);
				GUI_DispDecAt(pState0_p1.v-50 ,400,20,4);
...
static void _cbDialog_P2(WM_MESSAGE * pMsg) {
  WM_HWIN hItem;
	WM_HWIN hScrollBar0,hScrollBar1,hScrollBar2;
	WM_HWIN hWin=pMsg->hWin;
	//WM_SCROLL_STATE pState;
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_P2_SCROLLBAR_0: // Notifications sent by 'Scrollbar'
      switch(NCode) {
        ...
        WM_GetScrollState(hScrollBar0,&pState0_p2);
				...
				GUI_SetColor(GUI_RED);
				GUI_SetTextMode(GUI_TM_TRANS);
				GUI_DispDecAt(pState0_p2.v ,400,20,3);
    ...
    case ID_P2_SCROLLBAR_2: // Notifications sent by 'Scrollbar'
      switch(NCode) {
	     case WM_NOTIFICATION_VALUE_CHANGED:
        WM_GetScrollState(hScrollBar2,&pState1_p2);
				WM_SelectWindow(hWinPage2);
				GUI_SetColor(GUI_WHITE);
				GUI_FillRect(400,120,600,170);
				GUI_SetColor(GUI_RED);
				GUI_SetTextMode(GUI_TM_TRANS);
				GUI_DispDecAt(pState1_p2.v ,400,120,3);
        break;
...
static void _cbDialog_P3(WM_MESSAGE * pMsg) {
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_P3_SCROLLBAR_0: // Notifications sent by 'Scrollbar'
      switch(NCode) {
        ...
        WM_GetScrollState(hScrollBar0,&pState0_p3);
				...
				GUI_SetColor(GUI_RED);
				GUI_SetTextMode(GUI_TM_TRANS);
				GUI_DispDecAt(pState0_p3.v ,400,20,3);
    ...
    case ID_P3_SCROLLBAR_2: // Notifications sent by 'Scrollbar'
      switch(NCode) {
	     case WM_NOTIFICATION_VALUE_CHANGED:
        WM_GetScrollState(hScrollBar2,&pState1_p3);
				WM_SelectWindow(hWinPage3);
				GUI_SetColor(GUI_WHITE);
				GUI_FillRect(400,120,600,170);
				GUI_SetColor(GUI_RED);
				GUI_SetTextMode(GUI_TM_TRANS);
				GUI_DispDecAt(pState1_p3.v ,400,120,3);
        break;
...
static void _cbDialog_P4(WM_MESSAGE * pMsg) {
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_P4_SCROLLBAR_0: // Notifications sent by 'Scrollbar'
      switch(NCode) {
        ...
        WM_GetScrollState(hScrollBar0,&pState0_p4);
				...
				GUI_SetColor(GUI_RED);
				GUI_SetTextMode(GUI_TM_TRANS);
				GUI_DispDecAt(pState0_p4.v ,400,20,3);
    ...
    case ID_P4_SCROLLBAR_2: // Notifications sent by 'Scrollbar'
      switch(NCode) {
	     case WM_NOTIFICATION_VALUE_CHANGED:
        WM_GetScrollState(hScrollBar2,&pState1_p4);
				WM_SelectWindow(hWinPage4);
				GUI_SetColor(GUI_WHITE);
				GUI_FillRect(400,120,600,170);
				GUI_SetColor(GUI_RED);
				GUI_SetTextMode(GUI_TM_TRANS);
				GUI_DispDecAt(pState1_p4.v ,400,120,3);
        break;
...
static void _RC_WM1_Iconview(void) {
  ...
  */
  hWin = ICONVIEW_CreateEx(100-27, 80, 100, 400, 
                           _RC_hWindow1, WM_CF_SHOW | WM_CF_HASTRANS, 
                           0, GUI_ID_ICONVIEW_WM1, 55, 60);
...
void MainTask(void) {
  ...
  // unsigned i;
	//  int      Add;
  //int      Sel;
	WM_MESSAGE* pMsg_win2;
	WM_MESSAGE* pMsg_win3;
	
  unsigned int _angle[4]={135,160,185,225};
  //unsigned int i=0;
  
	pMsg_win2->MsgId=WM_PAINT;
	//pMsg_win2->hWin=_RC_hWindow2;
	//pMsg_win2->hWinSrc=_RC_hWindow2;
	
	pMsg_win3->MsgId=WM_PAINT;
	//pMsg_win3->hWin=_RC_hWindow3;
	//pMsg_win3->hWinSrc=_RC_hWindow3;
  ...
  while (1) {
    ...
    WM_SendMessageNoPara(WM_HBKWIN, MSG_MOVE); // Message for moving the toucan
		...
		*/
		...
		_textnum[3].num =MODEL_X.DR;	
		_textnum[4].num =MODEL_X.ATL;	
		_textnum[5].num =RC_DATA.RX_BAT/1000;	
		WM_Paint(_RC_hWindow2);
		
		//window3
		//WM_SendMessage(_RC_hWindow3, pMsg_win3);
		//_RC_cbWindow3(pMsg_win3);
		//WM_Paint(_RC_hWindow3);
		
		//window4
		_angle[0]=DASH_BOARD[0];
		_angle[1]=DASH_BOARD[1];
		if(WM_GetActiveWindow()==WM_HBKWIN)		
		_Dashboard(&_angle[0]);	

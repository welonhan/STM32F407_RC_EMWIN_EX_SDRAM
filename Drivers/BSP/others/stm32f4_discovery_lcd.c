...
/**
  ...
  *			None
  */
void BSP_LCD_BACKLIGHT_PWM_Init(void)
{
...
void LCD_Init(void)
{
  ...
  SRAM_Timing.AddressSetupTime       = 2;							//2
  SRAM_Timing.AddressHoldTime        = 1;						//1
  SRAM_Timing.DataSetupTime          = 5;					//5
  SRAM_Timing.BusTurnAroundDuration  = 1;
  //SRAM_Timing.CLKDivision            = 16;				//0
